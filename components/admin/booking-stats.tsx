...
import { CalendarDays, CheckCircle, Clock, XCircle, DollarSign } from "lucide-react"
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">حجز مؤكد</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">حجز في الانتظار</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">حجز ملغي</p>
        </CardContent>
      </Card>
